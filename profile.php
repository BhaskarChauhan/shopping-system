...
?>
	...
	<div class="containter  py-5">
		<div class="d-flex justify-content-center">
			...
			<div class="card" style="margin-top:50px;margin-bottom: 100px;width: 30rem;">
        		<div class="card-header"><h4 class="text-center">Profile</h4></div>
        		<div class="card-body">
        			<form method="post" id="profile_form">
					    ...
					    <div class="form-group">
					        ...
					        <img src="img/<?php echo $row['user_image']; ?>" class="img-thumbnail" width="250"  />
